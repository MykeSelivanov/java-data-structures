...
public class SearchMainApp {
    public static void main(String[] args) {
        ...
        System.out.println("Binary search recursive: " + myBinarySearchRecursive.binarySearchRecursive(myArray, 112));

        // Binary search iterative
        var myBinarySearchIterative = new MyBinarySearchIterative();
        System.out.println("Binary search iterative: " + myBinarySearchIterative.binarySearchIterative(myArray, 112));
